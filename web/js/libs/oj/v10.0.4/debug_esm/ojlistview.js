...
import { enableAllFocusableElements, disableAllFocusableElements, _DATA_OJ_TABMOD, isContainOpenPopup, isClickthroughDisabled, handleActionablePrevTab, handleActionableTab, getFocusableElementsInNode, disableDefaultBrowserStyling } from 'ojs/ojdatacollection-common';
  ...
  */
  ...
  HandleBlur: function (event) {
    ...
    if (this._isActionableMode()) {
      ...
      if (isContainOpenPopup(this.getListContainer())) {
        return;
      }
