...
define(['exports', 'jquery', 'ojs/ojcore-base', 'ojs/ojdomutils'], function (exports, $, oj, DomUtils) {
  ...
  DataCollectionUtils.isContainOpenPopup = function (elem) {
    ...
    for (var i = 0; i < popups.length; i++) {
      ...
      var launcher = DomUtils.getLogicalParent($(popupElem)); // Check if the listview contains the launcher
  ...
  var isContainOpenPopup = DataCollectionUtils.isContainOpenPopup;
